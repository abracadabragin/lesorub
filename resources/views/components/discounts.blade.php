<section class='jumbotron mb-0' id='discounts'>
    <div class='container'>
        ...
        <div class='row'>
            <div class='align-self-center col-lg-1 owl-prev d-none d-lg-block'>
                    ...
                    @foreach($params['discounts'] as $discount)
                        <div class="card text-center">
                            <img class="card-img-top img-rounded owl-lazy show-description"
                                 data-src="{{ asset("storage" . $discount['photos'][0]) }}"
                                 data-id="{{ $discount['id'] }}"
                                 data-toggle="modal"
                                 data-target=".modalShowProduct"
                                 alt="Discount product image">
                            <div class="card-body">
            ...
            <div class='align-self-center col-lg-1 owl-next d-none d-lg-block'>
